...
export interface ApiHomeGalleryHomeGallery extends Schema.CollectionType {
  collectionName: 'home_galleries';
  info: {
    displayName: 'home-gallery';
    pluralName: 'home-galleries';
    singularName: 'home-gallery';
  };
  options: {
    draftAndPublish: true;
  };
